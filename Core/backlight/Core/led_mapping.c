...
// Fixed LED mapping with green and blue CS pins corrected
const rgb_led_mapping_t RGB_LED_MAP[] = {
    // IC1 Coverage - 66 RGB LEDs
    // Row 0: F-key row (14 keys)
    {0, 11, 18, 16, 17, 0, 0},     // ESC - Fixed: green=16, blue=17
    ...
    {0, 11, 15, 13, 14, 0, 11},    // F11 - Fixed: green=13, blue=14
    ...
    {0, 2, 15, 13, 14, 1, 6},      // 6
    {0, 1, 15, 13, 14, 1, 7},      // 7
    {0, 11, 12, 10, 11, 1, 8},     // 8 - Fixed: green=10, blue=11
    {0, 10, 12, 10, 11, 1, 9},     // 9
    {0, 9, 12, 10, 11, 1, 10},     // 0
    ...
    {0, 5, 12, 10, 11, 2, 0},      // TAB
    {0, 4, 12, 10, 11, 2, 1},      // Q
    {0, 3, 12, 10, 11, 2, 2},      // W
    {0, 2, 12, 10, 11, 2, 3},      // E
    {0, 1, 12, 10, 11, 2, 4},      // R
    {0, 11, 9, 7, 8, 2, 5},        // T - Fixed: green=7, blue=8
    {0, 10, 9, 7, 8, 2, 6},        // Y
    {0, 9, 9, 7, 8, 2, 7},         // U
    {0, 8, 9, 7, 8, 2, 8},         // I
    {0, 7, 9, 7, 8, 2, 9},         // O
    {0, 6, 9, 7, 8, 2, 10},        // P
    {0, 5, 9, 7, 8, 2, 11},        // LBRACKET
    {0, 4, 9, 7, 8, 2, 12},        // RBRACKET
    {0, 3, 9, 7, 8, 2, 13},        // ENTER

    // Row 3: ASDF row (13 keys - IC1)
    {0, 2, 9, 7, 8, 3, 0},         // CAPS
    {0, 1, 9, 7, 8, 3, 1},         // A
    {0, 11, 6, 4, 5, 3, 2},        // S - Fixed: green=4, blue=5
    {0, 10, 6, 4, 5, 3, 3},        // D
    {0, 9, 6, 4, 5, 3, 4},         // F
    {0, 8, 6, 4, 5, 3, 5},         // G
    {0, 7, 6, 4, 5, 3, 6},         // H
    ...
    {0, 5, 6, 4, 5, 3, 8},         // K
    {0, 4, 6, 4, 5, 3, 9},         // L
    {0, 3, 6, 4, 5, 3, 10},        // SCOLON
    {0, 2, 6, 4, 5, 3, 11},        // QUOTE
    {0, 1, 6, 4, 5, 3, 12},        // HASH

    // Row 4: ZXCV row (12 keys - IC1)
    {0, 11, 3, 1, 2, 4, 0},        // LSHIFT - Fixed: green=1, blue=2
    ...
    {1, 1, 12, 10, 11, 3, 13},     // SWAP - Fixed: green=10, blue=11
    {1, 2, 12, 10, 11, 4, 12},     // UP
    {1, 3, 12, 10, 11, 4, 13},     // RSHIFT
    {1, 4, 12, 10, 11, 4, 11},     // SLASH
    {1, 4, 12, 10, 11, 5, 0},      // FN
    {1, 3, 9, 7, 8, 5, 1},         // LCTRL - Fixed: green=7, blue=8
    {1, 2, 9, 7, 8, 5, 2},         // LGUI
    {1, 1, 9, 7, 8, 5, 3},         // LALT
    {1, 4, 6, 4, 5, 5, 4},         // SPACE - Fixed: green=4, blue=5
    {1, 3, 6, 4, 5, 5, 5},         // RALT
    {1, 2, 6, 4, 5, 5, 6},         // RCTRL
    {1, 1, 6, 4, 5, 5, 7},         // LEFT
    {1, 4, 3, 1, 2, 5, 8},         // DOWN - Fixed: green=1, blue=2
    {1, 3, 3, 1, 2, 5, 9},         // RIGHT
};
